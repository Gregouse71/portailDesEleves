...
<body>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav class="cl-effect-13" id="cl-effect-13">
							<ul class="nav navbar-nav">
								...
								<li><a href="cours.php" class="active">Cours particuliers</a></li>
							</ul>
						</nav>
					</div>
					<!-- /.navbar-collapse -->
	...
	<div class="container">
		...
		<br>
		<div id="content">
		<iframe src="https://www.eleves.mines-paris.eu/petitscours/demander/" width="100%" style="border:none;" scrolling="no"></iframe>
